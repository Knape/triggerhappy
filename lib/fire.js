...
var fire = function fire() {
  ...
  var options = rest.reduce(_utils.mergeArrayObjects, {});
  // Append the correct client and page props to
  // the options object if we dont pass any
  if ((0, _utils.isElement)(element) && !(0, _utils.hasKeys)(options, 'clientX', 'clientY')) {
    Object.assign(options, (0, _utils.position)(element));
  }
